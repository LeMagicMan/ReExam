...
public class LaboratoryTest {
    ...
    IngredientState stateSolid = new IngredientState(IngredientState.State.Powder);
    IngredientState stateLiquid = new IngredientState(IngredientState.State.Liquid);
