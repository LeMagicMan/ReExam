...
public class DeviceTest {
    ...
    public void TransmorgrifierTest() throws Exception{
       ...
       transmogrifier.react(IngredientState.State.Powder);
    ...
    public void kettleTestQuantity() throws Exception{
        ...
        AlchemicIngredient smallIngredient1 = new AlchemicIngredient("Small",new Temperature(0,30), new IngredientState(IngredientState.State.Powder),new Quantity(5,PINCH));
        AlchemicIngredient smallIngredient2 = new AlchemicIngredient("Smaller",new Temperature(0,30),new IngredientState(IngredientState.State.Powder),new Quantity(4,PINCH));
        kettle.addIngredient(new IngredientContainer(testIngredient1, FluidUnit.BARREL));
